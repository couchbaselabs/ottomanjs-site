...
\+ **new ReferenceType**(`name`: string, `schema`: [Schema](schema.md), `refModel`: string, `options?`: [CoreTypeOptions](../interfaces/coretypeoptions.md)): *[ReferenceType](referencetype.md)*
...
**Returns:** *[ReferenceType](referencetype.md)*
