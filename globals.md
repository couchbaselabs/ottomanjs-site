...
Ƭ **LogicalWhereExpr**: *object | object | object | [CollectionSelectOperatorType](globals.md#collectionselectoperatortype) | [CollectionInWithinOperatorType](globals.md#collectioninwithinoperatortype)*
...
Ƭ **ModelTypes**: *[WhateverTypes](globals.md#whatevertypes) & typeof Model & object*
...
• **__ottoman**: *[Ottoman](classes/ottoman.md)*

Store default connection

___

### `Const` __ottomanInstances

• **__ottomanInstances**: *[Ottoman](classes/ottoman.md)[]* = []
...
▸ **buildViewIndexQuery**(`ottoman`: [Ottoman](classes/ottoman.md), `designDocName`: any, `indexName`: any, `fields`: any, `Model`: any): *(Anonymous function)*
...
▸ **connect**(`connectOptions`: [ConnectOptions](interfaces/connectoptions.md) | string): *void*
...
▸ **ensureN1qlIndexes**(`ottoman`: [Ottoman](classes/ottoman.md), `n1qlIndexes`: any): *Promise‹boolean›*
...
▸ **ensureViewIndexes**(`ottoman`: [Ottoman](classes/ottoman.md), `indexes`: any): *Promise‹undefined | true›*
...
▸ **getDefaultInstance**(): *[Ottoman](classes/ottoman.md)‹›*

**Returns:** *[Ottoman](classes/ottoman.md)‹›*

___

### `Const` getGlobalPlugins

▸ **getGlobalPlugins**(): *[PluginFunctions](globals.md#pluginfunctions)[]*

Return all global plugins

**Returns:** *[PluginFunctions](globals.md#pluginfunctions)[]*
...
▸ **getModelMetadata**(`modelConstructor`: any): *[ModelMetadata](interfaces/modelmetadata.md)*
...
### `Const` getOttomanIntances

▸ **getOttomanIntances**(): *[Ottoman](classes/ottoman.md)‹›[]*
...
▸ **getProjectionFields**(`selectDot`: string, `select`: [ISelectType](globals.md#iselecttype)[] | string | string[], `options`: object, `modelKey`: string): *object*
...
▸ **model**(`name`: string, `schema`: [Schema](classes/schema.md) | Record‹string, unknown›, `options?`: any): *[ModelTypes](globals.md#modeltypes)*
...
------ | ------ |
`name` | string |
`schema` | [Schema](classes/schema.md) &#124; Record‹string, unknown› |
`options?` | any |
...
▸ **queryBuildIndexDefered**(`indexName`: any, `fields`: any, `metadata`: [ModelMetadata](interfaces/modelmetadata.md), `on`: string): *string*
...
▸ **removeMany**(`metadata`: [ModelMetadata](interfaces/modelmetadata.md)): *(Anonymous function)*
...
(GenericManyQueryResponse)[(/classes/queryresponse.html)]
...
▸ **updateMany**(`metadata`: [ModelMetadata](interfaces/modelmetadata.md)): *(Anonymous function)*
